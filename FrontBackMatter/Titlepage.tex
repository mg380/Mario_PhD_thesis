...
%\begin{titlepage}
	\begin{center}
		...
		\Huge \textbf{\myTitle}\\ % Thesis title
		\huge \textit{\mySubtitle} \\[3cm]%Thesis sub-title		
		...
		\begin{minipage}{.45\linewidth}
			...
			\emph{Author:}\\
			\href{https://www.linkedin.com/in/mario-grandi}{\myName} % Author name - remove the \href bracket to remove the link
			\end{flushleft}
		\end{minipage}
		\hfill
		\begin{minipage}{.45\linewidth}
